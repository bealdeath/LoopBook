...
export default function AuthStack() {
  return (
    <Stack.Navigator initialRouteName="SignIn">
      ...
      <Stack.Screen name="ReceiptTracker" component={ReceiptTrackerScreen} options={{ title: "Receipt Tracker" }} />
      <Stack.Screen name="MileageTracker" component={MileageTrackerScreen} options={{ title: "Mileage Tracker" }} />
      <Stack.Screen name="SummaryExport" component={SummaryExportScreen} options={{ title: "Summary Export" }} />
      <Stack.Screen name="ReceiptEditor" component={ReceiptEditorScreen} options={{ title: "Edit Receipt" }} />
      <Stack.Screen name="ReceiptDetail" component={ReceiptDetailScreen} options={{ title: "Receipt Detail" }} />
      <Stack.Screen name="BulkUploadScreen" component={BulkUploadScreen} options={{ title: "Bulk Upload Receipts" }} />
      ...
      <Stack.Screen name="ReceiptOrganizer" component={ReceiptOrganizerScreen} options={{ title: "Organized Receipts" }} />
      <Stack.Screen name="AddExpense" component={AddExpenseScreen} options={{ title: "Add Expense" }} />
      <Stack.Screen name="InvoiceScreen" component={InvoiceScreen} options={{ title: "Invoice" }} />
      <Stack.Screen name="ReportsScreen" component={ReportsScreen} options={{ title: "Reports" }} />
      <Stack.Screen name="AiInsightsScreen" component={AiInsightsScreen} options={{ title: "AI Insights" }} />
      <Stack.Screen name="DashboardScreen" component={DashboardScreen} options={{ title: "Dashboard" }} />
      <Stack.Screen name="GameCenterScreen" component={GameCenterScreen} options={{ title: "Game Center" }} />
      ...
      <Stack.Screen name="PurchaseOrder" component={PurchaseOrderScreen} options={{ title: "Purchase Orders" }} />
      <Stack.Screen name="Sales" component={SalesScreen} options={{ title: "Sales" }} />
      <Stack.Screen name="SalesDetail" component={SalesDetailScreen} options={{ title: "Sales Detail" }} />
    </Stack.Navigator>
  );
}
